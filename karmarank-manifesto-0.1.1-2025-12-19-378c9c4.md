...
> Version: 0.1.1 (2025-12-19-378c9c4)
...
A criterion may be objective (e.g., "lines of code," "revenue generated"), but the _selection_ and _weighting_ of criteria are matters of taste and political convenience. There is no Golden Age to return to. The scorecard is ineradicably biased because the people keeping score are also playing the game.
...
When I showed my manager the Net Status-Weighted Karma formula, she wasn't upset because the math was wrong. It was disempowering to see years of political savvy and emotional labor collapsed into a cold one-liner.

The modern firm is a social network made of _people_ who, like you, have their own pre-rational tastes, preferences and sacred cows. But unlike you, most people are unwilling to decouple their private ledger from the firm's—to see things clearly.

The modern firm needs to maintain a public religion of "merit," "impact," and "values." People have to be able to say, with a straight face, that performance ratings emerge from neutral evaluation of objective contributions. If you insist on talking about Status weights and emotional payoff of stories, you are not "insightful." You are indecent.
...
You are expected to translate your moves back into the house liturgy: "driving business outcomes," "raising the quality bar," "delighting users," "living the leadership principles." The closer your internal model gets to "I am maximizing high-Status storytellers who enjoy endorsing me," the more aggressively you must wrap it in acceptable language.

This is not a conspiracy. It is a hygiene mechanism. If the firm acknowledged, openly, that your rating is a status-weighted sum of other people's feelings about you, half the building would quit and the rest would start playing even more nakedly political games. Strategic ambiguity keeps the story barely stable.

So you keep two layers:

- In your head, you run KarmaRank. You think in terms of fields, Status weights, stories in flight.
- Out loud, you speak HR doxa. You think in terms of impact, customers, team success.
...
This text is written in the forbidden dialect on purpose. Treat it like you would any other internal tool: useful in the debugger, suicidal in the release build.
...
**The Psychology:**
This manager is driven by **Competence**. They view the team as a machine and themselves as the Chief Architect. They care about efficiency, mastery, and "doing it right." They are allergic to fluff, marketing speak, and emotional appeals. They are often former Senior Engineers who were Peter-Principled into management.

**The Litmus Test:**
* **The 1:1 Test:** Do they naturally ask "Are you blocked?" (Process) or "How are you feeling?" (People)?
* **The Risk Test:** How do they react to a hacky hotfix? If they visibly wince and demand a refactor ticket immediately, they are a Technician.
* **The Praise Test:** They light up when you mention latency reduction or code deletion. They gloss over "great cross-team collaboration."

**The Interaction Protocol:**
* **Currency:** Accuracy & Efficiency.
* **Day-to-Day:** Speak in integers. Do not tell them you "improved" the system; tell them you "reduced build times by 14%."
* **The Trap:** Do not try to dazzle them with "Vision." They will drill down into the implementation details until they find a flaw, and then they will stop trusting you.

**How they argue in court:**
"My client’s output is 20% higher than the L5 baseline. The data demands a promotion. If we don't promote them, our leveling rubric is invalid."

## 2. The Politician (The "Power" Manager)

**The Psychology:**
This manager is driven by **Influence**. Do not confuse them with a "Climber" who just wants a raise. They view the team as an operational sphere and a stepping stone to the next level of organizational control. They care about "optics," "alignment," and "visibility." They want to be seen as a Kingmaker who grooms future leaders.

**The Litmus Test:**
* **The 1:1 Test:** Do they spend 15 minutes talking about what the VP said in the All-Hands?
* **The Risk Test:** How do they react to a project that has high technical value but zero visibility? They will likely kill it or starve it of resources.
* **The Praise Test:** They light up when you mention you presented to another team or "unblocked the Director's initiative."

**The Interaction Protocol:**
* **Currency:** Status & Alignment.
* **Day-to-Day:** Connect your work to the "Narrative." Never just fix a bug; always "remove a blocker for the Q3 Strategy." Name-drop the people they want to impress.
* **The Trap:** Do not bore them with technical nuance. If you explain the complexity of the database migration, their eyes will glaze over. Tell them *who* the migration helps.

**How they argue in court:**
"My client isn't just coding; they are driving the VP’s Q3 strategy. Promoting them solidifies our department's leadership in this domain."

## 3. The Peacemaker (The "Affiliation" Manager)

**The Psychology:**
This manager is driven by **Connection**. They view the team as a family. They care about morale, retention, and everyone getting along. **Warning:** This is the most dangerous attorney to have. In a calibration fight, they are prone to folding early to avoid conflict with their peers. They value their relationship with the other managers more than they value winning your case.

**The Litmus Test:**
* **The 1:1 Test:** Do they spend the first 20 minutes chatting about your weekend or your hobbies?
* **The Risk Test:** How do they react to you having a conflict with another team? They will immediately try to "smooth it over" rather than fighting for your side.
* **The Praise Test:** They light up when you mention mentorship, onboarding new hires, or organizing team socials.

**The Interaction Protocol:**
* **Currency:** Harmony & Safety.
* **Day-to-Day:** Position yourself as the "Glue." Highlight how you help others. If you are aggressive or competitive, they will view you as a threat to the tribe's stability.
* **The Trap:** Do not rely on them to be aggressive for you. You must manufacture the spine they lack.

**How they argue in court:**
"My client is the glue holding the team together. If we don't recognize them, we risk morale issues and attrition."
...
* **Technician:** The Mythical Man-Month, Designing Data-Intensive Applications, or a specific language reference. (Focus: Craft).
* **Politician:** The First 90 Days, High Output Management, 7 Habits. (Focus: Effectiveness/Strategy).
* **Peacemaker:** Radical Candor, The Five Dysfunctions of a Team, Nonviolent Communication. (Focus: Human Dynamics).

When you follow up with “how was this book transformative _for you_?”, you open the floor for them to reveal who the _were_ and who they _wanted to become_. This should strongly indicate their dominant managerial archetype.
...
This journey began with a cold dismantling of your worldview. It ends with a challenge.
...
The Optimizer keeps analyzing until they find the **mechanism**. They don't waste calories judging the "Judge" for not reading the code. They accept the Calibration Court as a boundary condition of the simulation.

A truly cynical engineer does not yell at gravity; they build an airplane.

## 2. A Defense of the Court Mechanism

It's tempting to treat calibration as a moral failure: "politics," "bias," "vibes," the triumph of charisma over truth. But to cross the uncanny valley, try to model the firm as an optimizer under constraints. In this light, calibration starts to look less like corruption and more like a convergent solution to an ugly valuation problem.
...
Calibration courts are plausibly a locally Pareto optimal (or at least evolutionarily stable) mechanism given leadership's constraints and objectives. This is not a claim that the system is fair, kind, unbiased, or truth-tracking. It's a claim about mechanism design: you can't eliminate valuation; you can only decide where it lives and how it fails.
...
The practical takeaway is not "respect the Court." The takeaway is: stop pretending you're in a lab. You're in a trial.

**Documents don't testify. People testify.**

If your work cannot survive cross-examination—if it has no credible witnesses ($S_i$) and no legible story ($k_i$)—then as far as the Court is concerned, it is hearsay.

## 3. The Asymmetric Advantage
...
It is a complex, probabilistic state machine with inputs, outputs, and weighting functions. It is messy, and often under-specified, but it can become legible. And you have a massive, asymmetric advantage over the "pure politicians" you fear.
...
## 4. From the Palliative Lie to Karmic Price Discovery
...
## 5. The Cost of Clarity

There is a price to pay for this clarity.

You must endure the mental discomfort of dissociation. You must detach your personal Moral Compass from your economic engine. You must accept that you can be "Right" (technically) and "Broke" (politically) at the same time.
