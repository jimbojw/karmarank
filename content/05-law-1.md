<!-- NAV_HEADER_START -->
[← Security Advisory](./04-security-advisory.md) | [TOC](../README.md#table-of-contents) | [Law #2: The Rating Is The Job →](./06-law-2.md)
...
![Private Ledger (left) is not equal to the Firm Ledger (right).](images/two-ledgers.light.png#gh-light-mode-only)![Private Ledger (left) is not equal to the Firm Ledger (right).](images/two-ledgers.dark.png#gh-dark-mode-only)
