...
It is a common yet critical mistake to assume these ledgers are the same system with some measurement noise. They're not. They are different databases with different schemas, occasionally synced only by accident. Like when January 1st lands on a Sunday.
